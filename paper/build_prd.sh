#!/usr/bin/env bash
# Build the Physical Review D PDF (revtex4-2) for Paper I from SEDE_foundations.md.
...
cd "$(dirname "$0")"
mkdir -p tex
BASE=SEDE_foundations
BIB=refs_foundations
...
# point at this paper's bibliography file (refs_foundations.bib, not refs.bib)
